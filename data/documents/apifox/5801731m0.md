...
```properties
properties.additional=https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/swagger.config
```
...
```properties
properties.additional=https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/swagger.advanced.config
```
...
- 简单分组可以在 Preferences(Settings) > Other Settings > ApiFoxHelper 下面配置
  - Recommend > (取消勾选)`javax.validation`
  - Recommend > (取消勾选)`support_mock_for_javax_validation`
  - Recommend > (勾选)`javax.validation(grouped)`
  - RemoteConfig > (取消勾选) https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/javax.validation.config
  - RemoteConfig > (勾选) https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/javax.validation-group.config
...
```properties
properties.additional=https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/javax.validation.config
```
...
3. 在 Preferences(Settings) > Other Settings > Apifox Helper > BuiltinConfig 或者[本地文件](https://docs.apifox.com/5801720m0.md)引入配置:

```
properties.additional=https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/dubbo.config
```

4. 如果配置不满足预期, 复制并修改 [dubbo.config](https://cdn.apifox.com/ide-plugin/idea/apifox-helper/setting/dubbo.config) 的内容放在配置里, 替换掉上面的引入配置

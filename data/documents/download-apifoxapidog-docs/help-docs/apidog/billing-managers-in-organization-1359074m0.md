...
Click the "Invite" button to open a pop-up window. Enter one or more email addresses. An invitation to become a billing manager in the organization will be sent to those emails. The invitee must log in to the Apidog account linked to the invitation email and and accept the invitation to officially join the organization as a billing manager. Invitations are valid for 7 days and cannot be used after they expire.

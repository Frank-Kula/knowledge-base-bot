...
| Task | Description |
|------|-------------|
| **Field Descriptions** | Generate clear, contextual descriptions for schema fields |
| **Mock Rules** | Create realistic mock data rules for testing |
| **Schema Refinement** | Improve overall schema structure and completeness |
| **Batch Updates** | Apply changes to multiple fields at once |

## Using AI to Modify Schemas

### Step 1: Access the AI Feature
...
### Step 3: Use Quick Suggestions or Custom Prompts

To make things even easier, we've included a few one-click suggestions for common edits — just tap to let the AI generate content for you. Alternatively, you can type custom instructions in natural language.

<details>
<summary>📷 AI Schema Modification Demo</summary>
<Background>
